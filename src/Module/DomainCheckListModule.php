...
namespace LocalbrandingDe\AntagusApiBundle\Module;
...
class DomainCheckListModule extends \Module
{
    ...
    { 
        ...
        $result=\Database::getinstance()->prepare('SELECT id,lsShopProductPrice,lb_limitation FROM tl_ls_shop_product WHERE alias = ?')->execute("domain-".$tld);
